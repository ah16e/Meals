                        ...
                        <div class="inner text-center">
                            ...
                            <div class="layer2 p-2 ">
                                <h3 class="text-black">${arr2[i].strCategory}</h3>
                                 <p>${arr2[i].strCategoryDescription.split(" ").slice(0,20).join(" ")}</p>
                            </div>
                        </div>
                    </div>`
    }
...
function displayArea(area) {
    ...
    for (let i = 0; i < area.length; i++) {
        ...
        cartona += `<div class="col-md-3 text-white">
                        <div onclick="getDetails(${$arr[i].strArea}" class="rounded-2 text-center cursor-pointer">
                            <i class="fa-solid fa-house-laptop fa-4x"></i>
                            <h3 id="ahmed" >${arr[i].strArea}</h3>
                        </div>
                    </div>`
    }
    rowData.innerHTML = cartona;
...
async function getAreaMeals() {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        <div class="inner text-center">
            ...
            <div class="layer p-2">Hambozo</div>
        </div>
    </div>`
    }
    rowData.innerHTML = cartona;
